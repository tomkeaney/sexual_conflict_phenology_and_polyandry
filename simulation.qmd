...
where $t_0$ is the $t$ value of the functions midpoint. The function saturates at 1, which indicates the point where female fecundity is no longer limited by resource abundance. Here's what it looks like for different values of $t_0$, with $k$ = 1.
